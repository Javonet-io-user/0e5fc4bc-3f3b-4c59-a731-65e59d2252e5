...
import jio.System.*;public class NBPClient {protected NObject javonetHandle; public NBPClient (){ try {  javonetHandle = Javonet.New("NBPExchangeRates.NBPClient");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public NBPClient(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public static java.lang.String GetExactTableLink (DateTime date){ try { return  (java.lang.String) Javonet.getType("NBPClient").invoke("GetExactTableLink",date);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }/**
	 * Method
	 */
            public static java.lang.String GetLatestTableLink (DateTime date){ try { return  (java.lang.String) Javonet.getType("NBPClient").invoke("GetLatestTableLink",date);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }/**
	 * Method
	 */
            public static NBPExchangeRate GetLatestExchangeRate (DateTime date,java.lang.String currencySymbol){ try { return new NBPExchangeRate((NObject)Javonet.getType("NBPClient").invoke("GetLatestExchangeRate",date,currencySymbol));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }	static {
		try {
