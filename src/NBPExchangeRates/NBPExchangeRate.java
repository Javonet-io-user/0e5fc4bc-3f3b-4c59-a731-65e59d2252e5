...
import NBPExchangeRates.*;public class NBPExchangeRate {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.math.BigDecimal getConversionRate (){ try { return  (java.math.BigDecimal) javonetHandle.get("ConversionRate");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public java.math.BigDecimal getExchangeRate (){ try { return  (java.math.BigDecimal) javonetHandle.get("ExchangeRate");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public java.lang.String getCurrency (){ try { return  (java.lang.String) javonetHandle.get("Currency");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public NBPExchangeRate (java.lang.String tableNumber,java.math.BigDecimal conversionRate,java.math.BigDecimal exchangeRate,java.lang.String currency){ try {  javonetHandle = Javonet.New("NBPExchangeRates.NBPExchangeRate",tableNumber,conversionRate,exchangeRate,currency);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public NBPExchangeRate(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
